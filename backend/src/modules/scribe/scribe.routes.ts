...
const transcribeWithAudioStaging = async (params: {
  ...
  await studyService.assertAudioAllowed(params.consultaId, params.doctorId, {
    allowFinalUpload: true,
  });
...
export async function scribeRoutes(app: FastifyInstance) {
  ...
  app.post(
    ...
    async (request, reply) => {
      ...
      const { consultaId, pacienteId, secciones, resumenSugeridoIa, resumenActual } = request.body as any;
      ...
      try {
        ...
        await studyService.assertAiDraftVisibleForScribe(consultaId, {
          userId: doctorId,
        ...
        if (resumenSugeridoIa !== undefined || resumenActual !== undefined) {
          await scribeService.updateRecordSummary(record.id, {
            resumenSugeridoIa: resumenSugeridoIa ?? undefined,
            resumenActual: resumenActual ?? undefined,
            origen: "doctor",
          });
        }
  ...
  app.post(
    ...
    async (request, reply) => {
      ...
      const { action, contenido, resumenActual } = request.body as any;
