...
export default function EvaluationManagement() {
  ...
  return <div className="flex min-h-screen bg-background"><Sidebar /><main className="app-content flex-1 overflow-auto"><div className="mx-auto max-w-3xl px-4 py-7 md:px-8">
    <header className="mb-7 rounded-2xl border bg-card p-6 shadow-sm"><p className="text-xs font-semibold uppercase tracking-[.15em] text-primary">Administración del estudio</p><h1 className="mt-2 text-2xl font-bold">Asignaciones PDQI-9</h1><p className="mt-2 text-sm text-muted-foreground">Se crea una copia pseudonimizada y con orden ciego de los documentos A, B y C. El evaluador nunca recibe PII, audio, transcripción ni identidad del médico.</p></header>
